...
router.get('/:id_consulta', authMiddleware,checkPermiso('permisos_clinica'), consultaController.getConsulta);
router.get('/paciente/:id_paciente', authMiddleware,checkPermiso('permisos_clinica'), consultaController.getConsultasPaciente);
