...
const Antecedentes = require('../antecedentes/antecedentesModel');
const ExamenInicialExtraoral = require('../examenesOrales/examenInicialExtraoralModel');
const ExamenInicialIntraoral = require('../examenesOrales/examenInicialIntraoralModel');
