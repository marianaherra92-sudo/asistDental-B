...
router.get('/:id', authMiddleware,checkPermiso('permisos_pacientes'), pacienteController.getPacienteById);
router.get('/clinica/:id_clinica', authMiddleware,checkPermiso('permisos_pacientes'), pacienteController.getPacientesByClinica);
